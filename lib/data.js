...
export const MAQUINARIO = [
  { cod: "EXT-500",  nome: "Extrusora EXT-500",             spec: "Ração extrusada • 500 kg/h",         tag: "Linha de produção" },
  { cod: "MM-30",    nome: "Moinho de Martelo MM-30",       spec: "Moagem de grãos • 1.500 kg/h",       tag: "Moagem" },
  { cod: "MH-1000",  nome: "Misturador Horizontal MH-1000", spec: "Homogeneização • 1.000 kg/batelada", tag: "Mistura" },
